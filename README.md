...
- `guides/diagrams/` — SVG figures embedded in guides 2, 3 and 6, generated by
  `python3 guides/diagrams/make_diagrams.py` (stdlib only). Dimensions are constants at
  the top of each `diag_NN.py`; edit there and rerun when the cut list changes.
